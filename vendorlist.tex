Part Name,Part Number,Quantity,Cost per Item,Total Cost,Vendor Name,Website/Link,NOTES
...
HLS-LFCD2 360° 2D LiDAR Laser Radar Scanner Lidar Sensor Distance Detection Kits,,3, $ 39.99 , $ 119.97 ,ebay,https://www.ebay.com/itm/263891503159?chn=ps&_trkparms=ispr%3D1&amdata=enc%3A19voqOO41TSOtVZ_VdVbXOA21&norover=1&mkevt=1&mkrid=711-117182-37290-0&mkcid=2&mkscid=101&itemid=263891503159&targetid=1583904486842&device=c&mktype=&googleloc=9029755&poi=&campaignid=15275224983&mkgroupid=131097072938&rlsatarget=pla-1583904486842&abcId=9300697&merchantid=6296724&gclid=CjwKCAjwjMiiBhA4EiwAZe6jQ_M6tviMvorl-9LJpTwueqhR3NCHG16owuxhqCmalgoPh2J-vvcTABoCJ0AQAvD_BwE,
...
DIANN 3pcs TB6612FNG Dual DC Stepper Motor Driver Module 1.2A Peak 3.2A Better Than L298N,,3, $ 5.00 , $ 15.00 ,DIANN store on Amazon,https://www.amazon.com/DIANN-TB6612FNG-Stepper-Driver-Module/dp/B0BLRSWTLM/ref=asc_df_B0BLRSWTLM/?tag=hyprod-20&linkCode=df0&hvadid=652498914210&hvpos=&hvnetw=g&hvrand=9724414743576374501&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9029755&hvtargid=pla-2032680066604&psc=1&gclid=CjwKCAjwjMiiBhA4EiwAZe6jQ5A701cq9ibXBDnKl6ZYJOMGH-aTJR4vQ8Y7vCOe8QxI4R0oDFI-QxoCo6gQAvD_BwE,
"954 (BALL CASTER WITH 3/4"" PLASTIC)",2183-954-ND,3, $ 3.99 , $ 11.97 ,,https://www.digikey.com/en/products/detail/pololu-corporation/954/10449799?utm_adgroup=Hardware%2C%20Fasteners%2C%20Accessories&utm_source=google&utm_medium=cpc&utm_campaign=Shopping_DK%2BSupplier_Pololu%20Corporation&utm_term=&utm_content=Hardware%2C%20Fasteners%2C%20Accessories&gclid=CjwKCAjwjMiiBhA4EiwAZe6jQz2bFMYZNjbtKzkk0eWGBoDHBD3AjIrH7l_k3NEJFTawAgK_TrW52hoCeOYQAvD_BwE,
3D printed Chassis (custom made),,3, $ 10.00 , $ 30.00 ,MEB (Lab 3D printer),,1. the cost is an estimate if we were to print outside of the lab.
\end{filescontents*}
...
\begin{table}[h!]
  ...
  %  \begin{adjustbox}{width=1\textwidth}
    ...
    \label{tab:Vendor List}
    \begin{tabular}{||c|c|c|c|c|c|c||}
      \bfseries {Part Name} & \textbf{Part Number} & \textbf{Quantity} & \textbf{Cost per Item} & \textbf{Vendor Name} & \textbf{Website/Link} & \textbf{Notes}\\
 \csvreader[head to column names]{vendorlist}{}
      {\\\hline\csvcoli&\csvcolii&\csvcoliii&\csvcoliiii&\csvcoliiiii&\csvcoliiiiii&\csvcoliiiiiii&}
      %ESP32-DevKitC-32UE Development Board &   & 4 & {\$10}& {\$40} & Espressif Store on Amazon & \href{http://www.overleaf.com}{Something Linky}  \\
      %2 & 10.1 & b\\
      %3 & 23.113231 & c\\
...
%\begin{table}[h!]
  %\begin{center}
    ...
    %\label{tab:Vendor List}
    %\begin{tabular}{||c|c|c|c|c|c|c||}
      %\textbf{Part Name} & \textbf{Part Number} & \textbf{Quantity} & \textbf{Cost per Item} & \textbf{Vendor Name} & \textbf{Website/Link} & \textbf{Notes}\\
      %$\alpha$ & $\beta$ & $\gamma$ \\
      %\hline
      %ESP32-DevKitC-32UE Development Board &   & 4 & {\$10}& {\$40} & Espressif Store on Amazon & \href{http://www.overleaf.com}{Something Linky}  \\
      %2 & 10.1 & b\\
